...
- Candidate admission now runs evaluator scoring only after archive novelty checks and the serial same-batch anti-race gate. Novelty-rejected duplicates therefore persist without score or evaluation metadata, and observer/web surfaces must continue to treat those fields as optional.
