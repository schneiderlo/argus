...
- [x] Implement the deterministic evaluator and novelty filter.
...
- The deterministic evaluator and novelty filter now live in `src/argus/eval/` with explicit heuristics, configurable similarity thresholds, and score-based node ranking helpers.
