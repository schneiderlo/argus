...
- `./scripts/verify.sh` now gates observer UI changes with `npm --prefix src/argus/render/ui run check` in addition to the Python compile, unittest, and Ruff passes.
